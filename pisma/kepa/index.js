function Kepa() {
    ...
    template = '<div id="wrap">\
            ...
            <div id="logo"><img src="pisma/kepa/orzelek.png" /><p>Kancelaria prezesa</br>wszystkich prezesów</p></div><br style="clear:both" />\
        ...
        <div id="sign"><p>Łączę wyrazy szacunku</p><img src="pisma/kepa/podpis.png" /></div>\
...
Kepa.prototype = DocumentPrototype;
